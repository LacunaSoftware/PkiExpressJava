...
public class PadesVisualText {
	...
	/**
	 * Gets the time format used when formatting the signature date.
	 *
	 * @return String The time format used when formatting the signature date.
	 */
	...
	/**
	 * Sets the time format to be used when formatting the signature date.
	 *
	 * @param signingTimeFormat The time format for the signature.
	 */
	...
	public PadesVisualTextModel toModel() {
		...
		model.setSigningTimeFormat(signingTimeFormat);
