...
public class CertificateExplorer extends PkiExpressOperator {
	...
	public CertificateExplorerResult open() throws IOException {
		if (certificatePath == null && trustServiceSession == null) {
			throw new RuntimeException("The certificate file or the certificate session were not set");
		}
